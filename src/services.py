...
def search_money_transfer_to_people(transactions_df: DataFrame) -> str:
    """
    Функция принимает DataFrame с данными об операциях и ищет переводы денег людям, если в описании указано
    имя в формате "Имя Ф.". Возвращает JSON объект с данными о подходящих транзакциях.
    """
